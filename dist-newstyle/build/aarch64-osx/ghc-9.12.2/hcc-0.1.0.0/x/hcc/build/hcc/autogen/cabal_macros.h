...
/* package hcc-0.1.0.0 */
#ifndef VERSION_hcc
#define VERSION_hcc "0.1.0.0"
#endif /* VERSION_hcc */
#ifndef MIN_VERSION_hcc
#define MIN_VERSION_hcc(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hcc */
...
#define CURRENT_COMPONENT_ID "hcc-0.1.0.0-inplace-hcc"
